...
> <span align="left" style="color:#FFF;background:#555;font:Courier New; font-size: 90%; padding-left: 20px; padding-right: 20px;"> docker network create wordpress-network </span>
